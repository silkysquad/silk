...
- Escrow transfer support (`silky pay`, `silky claim`, `silky cancel`)
- On-chain account support with operator delegation and spending limits
- Multi-wallet management (`silky wallet create`, `silky wallet list`)
- Address book for contacts (`silky contacts add/remove/list/get`)
...
- Support chat integration (`silky chat`)
- DevNet faucet for testing (`silky wallet fund`)
